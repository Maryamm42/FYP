  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flexDirection: 'row', padding: 50, marginTop: 20}}>
        <Pressable style={({ pressed }) => [{ flexDirection: "row", paddingHorizontal: 10, paddingVertical:25 ,borderRadius: 15, borderColor: pressed ? '#cfb536' : '#cfb536', borderWidth: 2, backgroundColor: pressed? '#cfb536': 'transparent', marginRight: 20, width: 150, justifyContent: "center"}]}>
