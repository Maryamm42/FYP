...
const UserChat = ({item}) => {
  ...
  return (
    <Pressable onPress={()=>navigation.navigate("Messages", {receipentId: item._id})} style={{flexDirection:"row", alignItems:"center",gap:10, borderWidth:0.7, borderColor:"#D0D0D0",
